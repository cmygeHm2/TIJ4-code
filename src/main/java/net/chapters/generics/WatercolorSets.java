package net.chapters.generics;//: generics/WatercolorSets.java
import net.chapters.generics.watercolors.*;
import java.util.*;

import static net.chapters.generics.watercolors.Watercolors.*;
