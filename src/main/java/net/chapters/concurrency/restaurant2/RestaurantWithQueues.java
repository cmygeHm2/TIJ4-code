...
// {Args: 5}
package net.chapters.concurrency.restaurant2;
import net.chapters.enumerated.menu.Course;
import net.chapters.enumerated.menu.Food;
import net.chapters.enumerated.menu.*;
